...
import { GalleryImg_1 } from "@/content/images/galleryImg";
import BgVector1 from "@/components/bgVector/bgVector";
import { motion, useInView, useAnimationControls } from "framer-motion";
import { useRef, useEffect } from "react";

export default function Projects() {
  const Gallery = GalleryImg_1();
  ...
  return (
    ...
    >
      <motion.div
        animate={controls}
        ref={ref}
        className="grid gap-4 z-20 relative"
      >
          ...
          >
            ...
            <div className="OverlayBox-Shadow absolute w-full h-full top-0 rounded-lg ">
              <div className="Overlay-text">
                <h4 className="text-4xl">Django & SQL</h4>
              </div>
            </div>
          </a>
        </div>
        <div className="grid grid-cols-10 gap-4 aboutResponsiveGrid-0">
          ...
          <div className="relative border-2 rounded-lg col-span-2">
            <a
              href="https://coruscating-caramel-714124.netlify.app/"
              target="_blank"
            >
              <Image
                className=" rounded-lg h-full w-full"
              ...
              <div className="OverlayBox-Shadow absolute w-full h-full top-0 rounded-lg OverlayBox-Shadow-green">
                <div className="Overlay-text">
                  <h4 className="projectResponsive-0">Repair Site</h4>
                </div>
              </div>
            </a>
          </div>
